...
namespace BanHangDienTu.Areas.Customer.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        public async Task<IActionResult> Create(ApplicationUser user)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    TempData["save"] = "Đã tạo thành công người dùng";
        ...
        public async Task<IActionResult> Edit(ApplicationUser user)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Đã cập nhật thành công người dùng";
                return RedirectToAction(nameof(Index));
            }
        ...
        public async Task<IActionResult> Locout(ApplicationUser user)
        {
            ...
            if (rowAffected > 0)
            {
                TempData["save"] = "Đã khóa người dùng thành công";
                return RedirectToAction(nameof(Index));
            }
            return View(userInfo);
        }
        ...
        public async Task<IActionResult> Active(ApplicationUser user)
        {
            ...
            if (rowAffected > 0)
            {
                TempData["save"] = "Đã kích hoạt người dùng";
                return RedirectToAction(nameof(Index));
            }
            return View(userInfo);
        }
