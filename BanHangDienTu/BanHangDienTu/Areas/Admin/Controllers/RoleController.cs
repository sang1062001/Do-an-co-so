using BanHangDienTu.Areas.Admin.Models;
...
namespace BanHangDienTu.Areas.Admin.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        public async Task<IActionResult> Create(string name)
        {
            ...
            if (isExist)
            {
                ViewBag.mgs = "Vai trò này đã tồn tại";
                ViewBag.name = name;
                return View();
            }
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Đã lưu vai trò thành công";
        ...
        public async Task<IActionResult> Edit(string id, string name)
        {
            ...
            if (result.Succeeded)
            {
                TempData["save"] = "Đã cập nhật vai trò này";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        public async Task<IActionResult> DeleteConfirm(string id)
        {
            ...
            if (result.Succeeded)
            {
                TempData["delete"] = "Đã xóa vai trò này";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
        ...
        public async Task<IActionResult> Assign(RoleUserVm roleUser)
        {
            ...
            {
                ViewBag.mgs = "Người dùng này đã được cấp quyền này rồi.";
                ViewData["UserId"] = new SelectList(_db.ApplicationUsers.Where(f => f.LockoutEnd < DateTime.Now || f.LockoutEnd == null).ToList(), "Id", "UserName");
                ViewData["RoleId"] = new SelectList(_roleManager.Roles.ToList(), "Name", "Name");
                return View();
            }
            ...
            if (role.Succeeded)
            {
                TempData["save"] = "Đã phân quyền người dùng.";
                return RedirectToAction(nameof(Index));
            }
            return View();
        }
